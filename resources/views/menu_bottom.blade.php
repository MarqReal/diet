		<div class="row bottom-bar">
				...
				<div class="col s3"><a href="/grafico" id="perfil" data-activates="mobile" class="button-collapse"><i class="material-icons icons-top icons-bottom {{(strpos('**'.$_SERVER['REQUEST_URI'], 'grafico')) > 0 ? 'option-activated' : ''}}">timeline</i></a></div>
		</div>
<style type="text/css">
		body {
