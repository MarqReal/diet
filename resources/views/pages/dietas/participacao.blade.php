		    ...
		    <div class="row">
		    	<div id="dietas" class="col s12">
		    		...
		    		<ul id="dieta{{$dieta->id}}" class="collapsible" data-collapsible="accordion">
					    <li>
					      <div class="collapsible-header"><i class="material-icons">room_service</i>Café da Manhã</div>
					      <div class="collapsible-body">
					      	@foreach($dieta->cafeManha as $item)
					      		<span>{{$item->nome}} : {{$item->pivot->quantidade}} (x)</span><br>
					      	@endforeach
					      </div>
					    </li>
					    <li>
					      <div class="collapsible-header"><i class="material-icons">room_service</i>Almoço</div>
					      <div class="collapsible-body">
					    ...
					    <li>
					      <div class="collapsible-header"><i class="material-icons">room_service</i>Café da Tarde</div>
					      <div class="collapsible-body">
