@extends('admin.layout.site')
	...
	@section('conteudo')
	<div class="row">
		<span class="title-page">Cadastro de nutricionistas</span>
			...
			$(".button-collapse").sideNav();
      		...
      		$("#btnSalvar").click(function () {
				...
				$.ajax({
    				...
    				url: '/nutricionista/cadastrar', // This is the url we gave in the route
			    	...
			    	success: function(response){ // What to do if we succeed
						...
						if (!resposta.error) {
							Swal.fire({
  								title: 'Sucesso!',
  								text: "Nutricionista cadastrado com sucesso",
  								type: 'success',
